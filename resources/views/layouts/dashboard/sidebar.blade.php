<aside id="sidebar" class="sidebar-right flex flex-col transition-all duration-500 border-l border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 group/sidebar w-64 [&.sidebar-collapsed]:w-20">
    <div class="header-section flex flex-col flex-shrink-0">
        <div class="flex items-center justify-between w-full group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:gap-6">
            <div class="flex items-center gap-1 min-w-0 group-[.sidebar-collapsed]/sidebar:justify-center group-[.sidebar-collapsed]/sidebar:gap-0">
            ...
            <div class="flex items-center gap-1 group-[.sidebar-collapsed]/sidebar:flex-col group-[.sidebar-collapsed]/sidebar:w-full group-[.sidebar-collapsed]/sidebar:items-center group-[.sidebar-collapsed]/sidebar:gap-4">
    ...
    <nav class="flex-1 px-3 space-y-2">
        <div class="space-y-2 group-[.sidebar-collapsed]/sidebar:hidden">
            <a href="{{ route('dashboard') }}" class="flex items-center p-2.5 rounded-xl transition-all hover:bg-zinc-100 dark:hover:bg-zinc-900 text-zinc-600 dark:text-zinc-400 {{ request()->routeIs('dashboard') ? 'bg-zinc-100 dark:bg-zinc-900 text-zinc-900 dark:text-white' : '' }}">
                <div class="flex-shrink-0 flex items-center justify-center w-6">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                    </svg>
                </div>
                <span class="font-bold mr-3 whitespace-nowrap">الرئيسية</span>
            </a>
            <a href="{{ route('business.index') }}" class="flex items-center p-2.5 rounded-xl transition-all hover:bg-zinc-100 dark:hover:bg-zinc-900 text-zinc-600 dark:text-zinc-400 {{ request()->routeIs('business.index') ? 'bg-zinc-100 dark:bg-zinc-900 text-zinc-900 dark:text-white' : '' }}">
                <div class="flex-shrink-0 flex items-center justify-center w-6">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                    </svg>
                </div>
                <span class="font-bold mr-3 whitespace-nowrap">أعمالي</span>
            </a>
            <a href="{{ route('business.create') }}" class="flex items-center p-2.5 rounded-xl transition-all hover:bg-zinc-100 dark:hover:bg-zinc-900 text-zinc-600 dark:text-zinc-400 {{ request()->routeIs('business.create') ? 'bg-zinc-100 dark:bg-zinc-900 text-zinc-900 dark:text-white' : '' }}">
                <div class="flex-shrink-0 flex items-center justify-center w-6">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                    </svg>
                </div>
                <span class="font-bold mr-3 whitespace-nowrap">إضافة بيزنس</span>
            </a>
        </div>

        <div class="hidden group-[.sidebar-collapsed]/sidebar:flex flex-col items-center space-y-2">
            <a href="{{ route('dashboard') }}" class="group/link flex items-center justify-center p-2.5 rounded-xl transition-all hover:bg-zinc-100 dark:hover:bg-zinc-900 text-zinc-600 dark:text-zinc-400 relative {{ request()->routeIs('dashboard') ? 'bg-zinc-100 dark:bg-zinc-900 text-zinc-900 dark:text-white' : '' }}">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('business.index') }}" class="group/link flex items-center justify-center p-2.5 rounded-xl transition-all hover:bg-zinc-100 dark:hover:bg-zinc-900 text-zinc-600 dark:text-zinc-400 relative {{ request()->routeIs('business.index') ? 'bg-zinc-100 dark:bg-zinc-900 text-zinc-900 dark:text-white' : '' }}">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('business.create') }}" class="group/link flex items-center justify-center p-2.5 rounded-xl transition-all hover:bg-zinc-100 dark:hover:bg-zinc-900 text-zinc-600 dark:text-zinc-400 relative {{ request()->routeIs('business.create') ? 'bg-zinc-100 dark:bg-zinc-900 text-zinc-900 dark:text-white' : '' }}">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="mt-auto px-3 pb-4 flex-shrink-0 space-y-4">
        <div class="user-section p-2 rounded-2xl bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-100 dark:border-zinc-800/50 transition-all relative flex items-center group/user group-[.sidebar-collapsed]/sidebar:p-1 group-[.sidebar-collapsed]/sidebar:bg-transparent group-[.sidebar-collapsed]/sidebar:border-transparent group-[.sidebar-collapsed]/sidebar:justify-center">
            ...
            <div class="min-w-0 mr-3 flex-1 transition-all duration-300 overflow-hidden group-[.sidebar-collapsed]/sidebar:hidden">
                <p class="text-sm font-bold truncate dark:text-zinc-100 text-zinc-900">{{ Auth::check() ? Auth::user()->name : 'مستخدم' }}</p>
                <p class="text-[10px] lowercase dark:text-zinc-500 text-zinc-400 truncate">{{ Auth::check() ? Auth::user()->email : 'mail@example.com' }}</p>
            </div>
        ...
        <div class="h-px w-full bg-zinc-200 dark:bg-zinc-800 group-[.sidebar-collapsed]/sidebar:hidden"></div>

        <div class="relative w-full">
            <div class="flex items-center justify-between w-full gap-1 group-[.sidebar-collapsed]/sidebar:hidden">
                <a href="{{ route('profile.edit') }}" class="flex-1 flex justify-center p-2.5 rounded-xl text-zinc-500 hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-all relative group/tip">
                    ...
                    <span class="pointer-events-none absolute bottom-full mb-2 left-1/2 -translate-x-1/2 px-2.5 py-1.5 bg-zinc-900 text-white dark:bg-white dark:text-zinc-950 text-[10px] rounded-lg opacity-0 group-hover/tip:opacity-100 transition-all translate-y-1 group-hover/tip:translate-y-0 whitespace-nowrap z-50 shadow-xl border border-zinc-200 dark:border-white font-bold">الإعدادات</span>
                </a>
                ...
                <div onclick="toggleTheme()" class="flex-1 flex justify-center p-2.5 rounded-xl text-zinc-500 hover:bg-zinc-100 dark:hover:bg-zinc-900 cursor-pointer transition-all relative group/tip">
                    ...
                    <span class="pointer-events-none absolute bottom-full mb-2 left-1/2 -translate-x-1/2 px-2.5 py-1.5 bg-zinc-900 text-white dark:bg-white dark:text-zinc-950 text-[10px] rounded-lg opacity-0 group-hover/tip:opacity-100 transition-all translate-y-1 group-hover/tip:translate-y-0 whitespace-nowrap z-50 shadow-xl border border-zinc-200 dark:border-white font-bold">تبديل الوضع</span>
                </div>
                ...
                <form action="{{ route('logout') }}" method="POST" class="flex-1">
                    ...
                    <button type="submit" class="w-full flex justify-center p-2.5 rounded-xl text-zinc-500 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 transition-all relative group/tip">
                        ...
                        <span class="pointer-events-none absolute bottom-full mb-2 left-1/2 -translate-x-1/2 px-2.5 py-1.5 bg-red-600 text-white text-[10px] rounded-lg opacity-0 group-hover/tip:opacity-100 transition-all translate-y-1 group-hover/tip:translate-y-0 whitespace-nowrap z-50 shadow-xl font-bold">خروج</span>
                    </button>
                </form>
            </div>

            <div class="hidden group-[.sidebar-collapsed]/sidebar:flex flex-col items-center w-full">
                <form action="{{ route('logout') }}" method="POST" class="w-full flex justify-center">
                    @csrf
                    <button type="submit" class="group/link flex items-center justify-center p-2.5 rounded-xl transition-all hover:bg-red-50 dark:hover:bg-red-500/10 text-zinc-500 hover:text-red-500 relative">
