...
@section('primary_color', '#f45018')
@section('toggle_icon_color', 'text-orange-500')
@section('glow_colors', '#f45018, #fb923c, #f45018')
@section('float_animation', 'floating_scale 5s ease-in-out infinite')
        ...
        <div class="relative z-10 w-full max-w-2xl mx-auto flex flex-col items-center">
            <div class="floating inline-block w-full max-w-sm mb-12">
                <div class="bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 p-12 rounded-[2.5rem] shadow-2xl relative overflow-hidden min-h-[320px] flex flex-col items-center justify-center">
                    ...
                    <span class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[12rem] font-[900] text-slate-300/70 dark:text-zinc-800/50 select-none z-0">404</span>
                    
                    <div class="relative z-10 flex flex-col items-center w-full h-full">
                        <div class="w-24 h-24 bg-primary/10 rounded-full mb-20 flex items-center justify-center backdrop-blur-sm">
                            <svg class="w-12 h-12 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z M10 7v3m0 4h.01"></path>
                            </svg>
                        </div>
            ...
            <div id="scroll-indicator" class="lg:hidden flex flex-col items-center gap-2 transition-all duration-500">
                <div class="w-[20px] h-[32px] border-2 border-slate-300 dark:border-zinc-700 rounded-full relative">
                    <div class="w-1 h-2 bg-primary rounded-full absolute top-1.5 left-1/2 -translate-x-1/2 animate-scroll-ar"></div>
                </div>
    ...
    <section class="w-full lg:w-[45%] min-h-screen flex flex-col justify-center px-8 py-12 lg:px-16 relative z-10 bg-white dark:bg-zinc-950 border-r lg:border-l border-slate-100 dark:border-zinc-900 order-2 lg:order-1 text-right">
        <div class="w-full max-w-md mx-auto fade-in">
            <header class="mb-10">
                ...
                <h1 class="text-4xl lg:text-5xl font-[900] text-slate-900 dark:text-white mb-4 leading-tight">عذراً، لقد <br><span class="glow-text">ضللت الطريق!</span></h1>
                <p class="text-slate-500 dark:text-zinc-400 font-medium text-lg leading-relaxed">الصفحة التي تبحث عنها غير موجودة في عالمنا. ربما تم تغيير الرابط، أو تم نقل الصفحة.</p>
            </header>
            
            <div class="flex flex-col sm:flex-row gap-4 mt-8">
                <a href="{{ url('/') }}" class="flex-1 flex items-center justify-center bg-primary text-white py-4 px-6 rounded-2xl font-black text-lg shadow-[0_10px_30px_rgba(244,80,24,0.3)] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300">العودة للرئيسية</a>
