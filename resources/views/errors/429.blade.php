    ...
    <section class="w-full lg:w-[45%] min-h-screen flex flex-col justify-center px-8 py-12 lg:px-16 relative z-10 bg-white dark:bg-zinc-950 border-r lg:border-l border-slate-100 dark:border-zinc-900 order-2 lg:order-1 text-right">
        <div class="w-full max-w-md mx-auto fade-in">
            <header class="mb-10">
                ...
                <h1 class="text-4xl lg:text-5xl font-[900] text-slate-900 dark:text-white mb-4 leading-tight">مهلاً، خذ <br><span class="glow-text">نفساً عميقاً!</span></h1>
                <p class="text-slate-500 dark:text-zinc-400 font-medium text-lg leading-relaxed">لقد قمت بإرسال عدد كبير جداً من الطلبات. النظام يحتاج للحظات ليستوعب كل هذا. انتظر قليلاً ثم حاول مجدداً.</p>
            </header>
            <div class="flex flex-col sm:flex-row gap-4 mt-8">
                <button onclick="window.location.href = window.location.href" class="flex-1 flex items-center justify-center bg-yellow-500 text-white py-4 px-6 rounded-2xl font-black text-lg shadow-[0_10px_30px_rgba(234,179,8,0.3)] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300">المحاولة مجدداً</button>
