                    ...
                    <div class="space-y-16">
                            ...
                            <div class="flex items-center gap-4 mb-6">
                                <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-primary to-orange-400 p-[2px] shadow-lg shadow-primary/20 group-hover:shadow-primary/40 transition-shadow duration-500 shrink-0">
                                    <div class="w-full h-full bg-white dark:bg-zinc-900 rounded-[14px] flex items-center justify-center">
                                        <svg class="w-6 h-6 text-primary group-hover:scale-110 transition-transform duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                                    </div>
                                </div>
                                <h2 class="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white tracking-tight">{{ __('legal.terms_account_title') }}</h2>
                            </div>
                            <p class="text-lg text-slate-600 dark:text-zinc-400 leading-relaxed">{{ __('legal.terms_account_desc') }}</p>
                        </section>
                        ...
                        <section class="group">
                            <div class="flex items-center gap-4 mb-6">
                                ...
                                <h2 class="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white tracking-tight">{{ __('legal.terms_content_title') }}</h2>
                            </div>
                            <p class="text-lg text-slate-600 dark:text-zinc-400 leading-relaxed">{{ __('legal.terms_content_desc') }}</p>
                        </section>
                        ...
                        <section class="group">
                            <div class="flex items-center gap-4 mb-6">
                                ...
                                <h2 class="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white tracking-tight">{{ __('legal.terms_rules_title') }}</h2>
                            </div>
                            <p class="text-lg text-slate-600 dark:text-zinc-400 leading-relaxed">{{ __('legal.terms_rules_desc') }}</p>
                        </section>
