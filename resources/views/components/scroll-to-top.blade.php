<button id="scrollToTopBtn" 
        class="fixed bottom-6 end-6 rtl:end-auto rtl:start-6 z-[90000] p-3.5 bg-primary/90 backdrop-blur-md text-white rounded-full shadow-lg shadow-primary/30 border border-white/10 hover:bg-primary hover:shadow-xl hover:shadow-primary/40 hover:-translate-y-1 transition-all duration-300 opacity-0 pointer-events-none translate-y-4 flex items-center justify-center group"
